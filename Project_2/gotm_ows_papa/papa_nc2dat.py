#!/usr/bin/env python3
"""
Qing Li, 20171103 w/modifications by Sam
"""
import sys
import argparse
import numpy as np
...
def ncread(infile, *argv, tidxstart=None, tidxend=None):
    ...
    for vname in argv:
        ...
        if vname == 'BP_915':
            print('converting to pascals')
            # For any vals in the array that are less than 1e10, multiply by 100
            odat = np.where(odat < 1e10, odat*100, odat)
